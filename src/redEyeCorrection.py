...
#read image
img = cv2.imread("redEyes.jpg") # pass the name of image to be read
...
for x,y,w,h in eyeRects:
	...
	#find all contours
	(contours, _, _) = cv2.findContours(mask.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)  # It return contours and Hierarchy
